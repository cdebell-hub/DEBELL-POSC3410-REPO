...
AnswerA <- "The columns represent variables which are the questions that respondents were asked on the GSS. The rows represent respondents."
...
Answer1_expectation <- "We have a bar graph with two variables. Sex should be on the X axis and Number should be on the Y axis. About a 50-50% split."
...
Answer1 <- "There are more females than males. Much more than the 50-50% expected split."
...
Answer2_Expectation <- "Bar graph. Race on X and Number on Y. White, Black, and Other. At least plurality White, around 15% Black, I don't know."
...
# Use a text vector to explain what is peculiar about the result that you see. 
Answer2 <- "The white column is much larger than anticipated."
...
str(gss_df$WTSSALL)
Question3_part1 <- "All the values in this variable are very small and less than ."
...
Question3_part2 <- "This is the variable that is used to weight all the other ones."
...
Answer5C <- "The bars do not go all the way up to 100%. I would change it so they total up to 100%. "
